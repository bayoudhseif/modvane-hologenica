...
public class HologramPodRenderer implements BlockEntityRenderer<HologramPodBlockEntity> {
    ...
    public void render(HologramPodBlockEntity blockEntity, float partialTick, PoseStack poseStack,
        ...
        if (terrain == null || blockEntity.needsRescan()) {
            terrain = scanTerrain(level, minX, maxX, minZ, maxZ);
    ...
    private void renderBlock(VertexConsumer c, Matrix4f m, Matrix3f n, int[][][] terrain,
    ...
    private void addQuad(VertexConsumer c, Matrix4f m, Matrix3f n,

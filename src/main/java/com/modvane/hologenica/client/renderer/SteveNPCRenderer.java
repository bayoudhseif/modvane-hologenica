...
// Renderer for Steve NPC - uses the actual player's skin and model (Steve or Alex)
public class SteveNPCRenderer extends MobRenderer<SteveNPCEntity, HumanoidModel<SteveNPCEntity>> {
    ...
    private final HumanoidModel<SteveNPCEntity> steveModel;
    private final HumanoidModel<SteveNPCEntity> alexModel;

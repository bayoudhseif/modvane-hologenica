...
public abstract class BaseModScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    ...
    // buttonRows: Number of button rows in this section
    // hasGapAfter: Whether this section has a gap after it
    ...
    // Get content width accounting for padding on both sides
    protected int getContentWidth() {
        return imageWidth - (2 * PADDING);
    }

    // Calculate button width for N buttons in a row
